...
const aiJourneyEvents={
  ...
  'sub-contracting':[
    ...
    {name:'Shipment Processing & Logistics Arrangement',chips:['Human Required','SAP S/4HANA'],source:'Planner / Logistics User',waitingOn:'Logistics User',
     desc:'Transporter, vehicle and packing are arranged, and package count, weight and dispatch mode are captured.',
    ...
    {name:'Stores Outbound / Goods Issue',chips:['Human Required','SAP S/4HANA'],source:'Stores User',waitingOn:'Stores User',
     ...
     validation:'Issued quantity must match the reservation; any short issue needs a reason code.',
...
const cfgJourneys=[
  ...
  {id:'sub-contracting',name:'Sub-Contracting Journey',category:'P2P',desc:'Runs a sub-contracting transaction end to end — the request and its approval, the commercial PO, the outbound shipment on a delivery challan, the vendor return, and reconciliation to closure.',status:'Active',tags:['18 steps','Planning, Stores, Logistics, Finance'],
    steps:[
      ...
      {name:'Shipment Processing & Logistics Arrangement',src:'Planner / Logistics User',type:'rule'},
...
const manualJourneyStepCatalog={
  ...
  'sub-contracting':[
    ...
    {name:'Shipment Processing & Logistics Arrangement',ownerRole:'Planner / Logistics User',manualAction:'Arrange transporter, vehicle and packing; capture weights, packages and the dispatch mode.',sla:'8h',agentCapable:false},
